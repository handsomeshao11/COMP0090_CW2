# Task script for the (unablated) V-Unet model
...
if __name__ == "__main__":
    ...
    ### Build and fit the (unablated) V-Unet model, with parameters fixed after pre-training
    ...
    model_name = 'vunet_unablated'
    setting = ['pretrain', 'non-ft']
    model = v_unet_model(img_shape, pre_train='imagenet', fine_tuning=False)
