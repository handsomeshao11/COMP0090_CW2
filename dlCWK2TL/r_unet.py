# Task script for the R-Unet model
...
if __name__ == "__main__":
    ...
    ### Build and fit the R-Unet model, with parameters fixed after pre-training
    ...
    # Set up the  R-Unet model
    model_name = 'runet'
    setting = ['pretrain', 'non-ft']
    model = r_unet_model(iimg_shape, pre_train='imagenet', fine_tuning=False)
