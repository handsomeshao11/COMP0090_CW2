# Task script for the M-Unet model
...
if __name__ == "__main__":
    ...
    ### Build and fit the M-Unet model, with parameters fixed after pre-training
    ...
    # Set up the M-Unet model
    model_name = 'munet'
    setting = ['pretrain', 'non-ft']
    model = m_unet_model(img_shape, pre_train='imagenet', fine_tuning=False)
